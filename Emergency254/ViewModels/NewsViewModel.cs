...
using Emergency254.Common;
using Emergency254.ExtensionMethods;
using Emergency254.Interfaces;
using Emergency254.Resources;
...
namespace Emergency254.ViewModels
{
    public class NewsViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        public AsyncRelayCommand _loadPostsAsyncCommand;
        ...
        public AsyncRelayCommand LoadCommand => loadCommand = loadCommand ??
            new AsyncRelayCommand(ExecuteLoadCommand);
        ...
        private async void SelectPost(Post post)
        {
            ...
            await App.Current.MainPage.Navigation.PushAsync(GetTabbedPage());
        }
